...
Label(win,text="Enter your URL",font="arial 24 bold",bg="White",fg="#1A1A1A").pack(fill="x")
...
#Button
Button(win,text="Click Here",font="times 14 bold",bg="black",fg="white",command=short).pack()
